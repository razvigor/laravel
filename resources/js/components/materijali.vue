                              ...
                              <div class="card-body ">
                                ...
                                <div class="row" v-show="materijal.mattip_id == 7 ||
                                  ...
                                  <div class="col-sm-7">
                                    <div class="form-group has-danger">
                                                                                                              <!-- -->
                                      <v-selectize :create-item="maybeCreate()" :options="mattipoznake_t" v-model="ob_selected" placeholder="izaberite oznaku" key-by="id" label="oznaka" :keys="['oznaka', 'oznaka_2', 'oznaka_3']"/>
                                      <!--
...
//alert('aa'+vrsta+'bb');
    ...
    watch: { 
      /*
      'ob_selected': (value) => { 
        f_azuriraj_slozeni_naziv(); 
        
      } 
      */
     'ob_selected': 'f_azuriraj_slozeni_naziv'
    },
    ...
    /// MATERIJALI  //////////////////////////////
        ...
        dodajMaterijal(){
          ...
          this.$nextTick(function(){ 
            ...
            //$('#izbor_mattipoznaka_id').selectpicker("refresh");  
                          ...
                          if (this.ob_selected){
                              this.ob_selected.id     = 0;//this.materijal.mattipoznaka_id;
                              this.ob_selected.oznaka  = 'obavezan unos';
                          }else{
                            this.ob_selected = {
                              id:    0,
                              oznaka: 'obavezan unos'
        ...
        izmjeniMaterijal(materijal){
          ...
          this.materijal.mattipoznaka_id = materijal.mattipoznaka_id; 
                          ...
                          // polja za pretraživu listu
                          if (this.ob_selected){
                              this.ob_selected.id     = materijal.mattipoznaka_id;//this.materijal.mattipoznaka_id;
                              this.ob_selected.oznaka  = materijal.oznaka;
                          }else{
                            this.ob_selected = {
                              id:    materijal.mattipoznaka_id,
                              oznaka: materijal.oznaka
                            } 
                          }
        ...
        snimiMaterijal(){
            ...
            if ((!this.ob_selected || this.ob_selected.id==0) && (this.materijal.mattip_id == 7 || this.materijal.mattip_id == 10) ){
                alert('Nije izabrana oznaka/boja!');

            } else{
                  //pokupi novo stanje
                  this.$forceUpdate();
                    /// uzimamo vrijednost iz dinamičkog selekta
                    this.materijal.mattipoznaka_id=this.ob_selected.id;
    ...
    /// izvršava se pri promjeni TIPA,VRSTE ili OSOBINE materijala u listi
        f_azuriraj_slozeni_naziv: function() {
            ...
            if (!this.ob_selected){
                  ...
                  if(this.ob_selected.id!=0){
                      v_naziv = v_naziv + ', '+this.ob_selected.oznaka;//$("#izbor_mattipoznaka_id option:selected").text().trim();
                  }             
            }
            ;
