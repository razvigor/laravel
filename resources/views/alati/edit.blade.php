...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('alat.update', $alat) }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('put')
            ...
            <div class="card ">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Podaci o alatu - izmjena') }}</h4>
              </div>
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('alatnaziv_id') ? ' has-danger' : '' }}">
                        ...
                        <option value="{{ $al_naz->id }}" {{ $al_naz->id == old('alatnaziv_id', $alat->alatnaziv_id) ? 'selected' : '' }}>{{ $al_naz->vrsta_namjena.' - '.$al_naz->naziv }}</option>
                        @endforeach
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-5">
                    <div class="form-group{{ $errors->has('proizvodjac_id') ? ' has-danger' : '' }}">
                        ...
                        <option value="{{ $proiz->id }}" {{ $proiz->id == old('proizvodjac_id', $alat->proizvodjac_id) ? 'selected' : '' }}>{{ $proiz->naziv }}</option>
                        @endforeach
                      </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('kataloski_br') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('kataloski_br') ? ' is-invalid' : '' }}" name="kataloski_br" id="input-kataloski_br" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value="{{ old('kataloski_br', $alat->kataloski_br) }}"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('dimenzija_opis') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('dimenzija_opis') ? ' is-invalid' : '' }}" name="dimenzija_opis" id="input-dimenzija_opis" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value="{{ old('dimenzija_opis', $alat->dimenzija_opis) }}"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('precnik') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('precnik') ? ' is-invalid' : '' }}" name="precnik" id="input-precnik" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value="{{ old('precnik', $alat->precnik) }}"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('vrsta_rez_mat') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}" {{ $value == old('vrsta_rez_mat', $alat->vrsta_rez_mat) ? 'selected' : '' }}>{{ $vrsta_rez_mat }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                        <div class="form-group{{ $errors->has('br_zuba_pera') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('br_zuba_pera') ? ' is-invalid' : '' }}" name="br_zuba_pera" id="input-br_zuba_pera" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value="{{ old('br_zuba_pera', $alat->br_zuba_pera) }}"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                        <div class="form-group{{ $errors->has('s_reza_p_rupe') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('s_reza_p_rupe') ? ' is-invalid' : '' }}" name="s_reza_p_rupe" id="input-s_reza_p_rupe" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value="{{ old('s_reza_p_rupe', $alat->s_reza_p_rupe) }}"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('smjer') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}" {{ $value == old('smjer', $alat->smjer) ? 'selected' : '' }}>{{ $smjer }}</option>
                            @endforeach
                          </select>
