@extends('layouts.app', ['activePage' => 'mat_tipovi', 'menuParent' => 'sifrarnici', 'titlePage' => __('Tipovi materijala - pregled')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Tipovi materijala') }}</h4>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table id="datatables" class="table table-striped table-no-bordered table-hover datatable-warning" style="display:none">
                    ...
                    <tbody>
                      ...
                      @foreach($mattipovi as $mattip)
                              <!-- Modal -->
                              <div class="modal fade modal{{ $mattip->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              ...
                                              <form method="post" action="{{ route('mattip.update', $mattip) }}" autocomplete="off" class="form-horizontal">
                                                ...
                                                <div class="card ">
                                                  ...
                                                  <div class="card-body ">
                                                    ...
                                                    <div class="row">
                                                      <label class="col-sm-4 col-form-label">{{ __('Redni broj') }}</label>
                                                      <div class="col-sm-2">
...
<div id="app"> <!-- ovo je samo da ne iskače greška--></div>
						...
						<tr>
                          ...
                          <td>
                            {{ $mattip->created_at->format('d-m-Y') }}
                          </td>
                          @can('manage-materijali', App\User::class)
                            <td class="td-actions text-right">
                              <!-- Button trigger modal -->
                              <button type="button" class="btn btn-warning" data-toggle="modal" data-target=".modal{{ $mattip->id }}" data-backdrop="static" data-keyboard="false">
