                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td  style="width: 60%;">
                                ...
                                {{$podatak->kupac_id=='0'?$podatak->kupac_ime : $detalji_kupca->naziv}}<br>
                                {{$podatak->kupac_id=='0'?'' :$detalji_kupca->ulica_i_broj}}<br>
                                {{$podatak->kupac_id=='0'?'' :$detalji_kupca->post_br_mjesto}}<br>
                                {{$podatak->kupac_id=='0'?'' :$detalji_kupca->drzava}}<br>
                                {{$podatak->kupac_id=='0'?'' :$detalji_kupca->jmb_jib}}<br>
                                @endforeach
