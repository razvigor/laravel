<div class="sidebar" data-color="azure" data-background-color="white" data-image="{{ asset('material') }}/img/Measuring-Tools.png">
  <!--
...
-->
  <div class="logo">
    <a href="http://www.normativ.ba" class="simple-text logo-mini">
      <i class="material-icons">home</i>
      
    </a>
    <a href="http://www.normativ.ba" class="simple-text logo-normal">
      {{ __('NORMATIV') }}
    </a>
  </div>
