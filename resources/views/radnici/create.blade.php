    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          ...
          <form method="post"  action="{{ route('radnik.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Podaci o novom radniku') }}</h4>
              </div>
              <div class="card-body ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="input-name" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('jmbg') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('jmbg') ? ' is-invalid' : '' }}" name="jmbg" id="input-jmbg" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('birthday') ? ' has-danger' : '' }}">
                          ...
                          placeholder="{{ __('Select date') }}" class="form-control datetimepicker" value="2000-01-01"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('birthplace') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('birthplace') ? ' is-invalid' : '' }}" name="birthplace" id="input-birthplace" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('adress') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('adress') ? ' is-invalid' : '' }}" name="adress" id="input-adress" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('telefon') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('telefon') ? ' is-invalid' : '' }}" name="telefon" id="input-telefon" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('drzavljanstvo') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('drzavljanstvo') ? ' is-invalid' : '' }}" name="drzavljanstvo" id="input-drzavljanstvo" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('nacionalnost') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}" >{{ $nacionalnost }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('vjeroispovjest') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}" >{{ $vjeroispovjest }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('vjerski_praznik') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('vjerski_praznik') ? ' is-invalid' : '' }}" name="vjerski_praznik" id="input-vjerski_praznik" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('bracno_stanje') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}">{{ $bracno_stanje }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('djeca') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('djeca') ? ' is-invalid' : '' }}" name="djeca" id="input-djeca" type="text" placeholder="{{ __('') }}" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('stambeno_pitanje') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}">{{ $stambeno_pitanje }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group{{ $errors->has('invalidnost') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}">{{ $invalidnost }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group{{ $errors->has('skolska_sprema') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}">{{ $skolska_sprema }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('naziv_ustanove') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('naziv_ustanove') ? ' is-invalid' : '' }}" name="naziv_ustanove" id="input-naziv_ustanove" type="text" placeholder="{{ __('') }}" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('zanimanje') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('zanimanje') ? ' is-invalid' : '' }}" name="zanimanje" id="input-zanimanje" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('posebna_znanja') ? ' has-danger' : '' }}">
                          <textarea name="posebna_znanja" id="input-posebna_znanja" cols="30" rows="10" class="form-control{{ $errors->has('posebna_znanja') ? ' is-invalid' : '' }}" placeholder="{{ __('kratak opis posebnih zananja') }}"></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        <div class="form-group{{ $errors->has('strucni_ispiti') ? ' has-danger' : '' }}">
                          <textarea name="strucni_ispiti" id="input-strucni_ispiti" cols="30" rows="10" class="form-control{{ $errors->has('strucni_ispiti') ? ' is-invalid' : '' }}" placeholder="{{ __('') }}"></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('p_radna_mjesta') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('p_radna_mjesta') ? ' is-invalid' : '' }}" name="p_radna_mjesta" id="input-p_radna_mjesta" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('p_opis_posla') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('p_opis_posla') ? ' is-invalid' : '' }}" name="p_opis_posla" id="input-p_opis_posla" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('p_trajanje') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('p_trajanje') ? ' is-invalid' : '' }}" name="p_trajanje" id="input-p_trajanje" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group{{ $errors->has('z_datum') ? ' has-danger' : '' }}">
                          ...
                          placeholder="{{ __('unesite datum zaposlenja') }}" class="form-control datetimepicker" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_staz') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_staz') ? ' is-invalid' : '' }}" name="z_staz" id="input-z_staz" type="text" placeholder="{{ __('') }}" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_status') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}">{{ $z_status }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_vrsta_RO') ? ' has-danger' : '' }}">
                            ...
                            <option value="{{ $value }}" >{{ $z_vrsta_RO }}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_org_cjelina') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_org_cjelina') ? ' is-invalid' : '' }}" name="z_org_cjelina" id="input-z_org_cjelina" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_radno_mjesto') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_radno_mjesto') ? ' is-invalid' : '' }}" name="z_radno_mjesto" id="input-z_radno_mjesto" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('z_angazovanja') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_angazovanja') ? ' is-invalid' : '' }}" name="z_angazovanja" id="input-z_angazovanja" type="text" placeholder="{{ __('') }}" required="true" aria-required="true" value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-5">
                        <div class="form-group{{ $errors->has('br_ormarica') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('br_ormarica') ? ' is-invalid' : '' }}" name="br_ormarica" id="input-br_ormarica" type="text" placeholder="{{ __('') }}"  value=""/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                        <div class="form-group{{ $errors->has('z_licni_dohodak') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_licni_dohodak') ? ' is-invalid' : '' }}" name="z_licni_dohodak" id="input-z_licni_dohodak" type="text" placeholder="{{ __('') }}" value="" />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                        <div class="form-group{{ $errors->has('z_radni_sat') ? ' has-danger' : '' }}">
                          <input class="form-control{{ $errors->has('z_radni_sat') ? ' is-invalid' : '' }}" name="z_radni_sat" id="input-z_radni_sat" type="text" placeholder="{{ __('') }}" value="" />
