        ...
        <div>
            <div class="row">
                <div class="col-xs-7">
                    ...
                    <br><br>
                    Datum: {{Carbon\Carbon::now()->format('d-m-Y')}}  <!--//->format('d-m-Y H:i:s')}}-->
                </div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <h4 style="text-align: center; font-size: 16px;">KALKULACIJA CIJENE KOŠTANJA</h4>
                    <address>
                        <table style="width: 100%;">
                           <tr><td class="text-right"><strong>Proizvod:</strong></td> <td class="text-left">{{$proizvod->naziv}}</tr>
                           <tr><td class="text-right"><strong>Šifra:</strong></td> <td class="text-left">{{$proizvod->sifra_proizvoda}}</tr>
                           <tr valign="top"><td class="text-right"><strong>Opis:</strong></td> <td class="text-left">{{$proizvod->opis}}</tr>
            ...
            <table style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr width="100%" style="{{ $tip->mattip_id==$stavke->mattip_id ? '' : 'display:none'}}">
                        ...
                        <td class="text-center">{{$stavke->potrosnja}}</td>
                    ...
                    @endforeach
                    <tr class="well" style="background: #e3eef8; padding: 5px">
                    ...
                    @endforeach
                        <tr class="well">
                            <th colspan="2"></th>
                            <th colspan="3" style="background: #e3eef8; padding: 5px;" class="text-right"><div> Ukupno - troškovi materijala</div></th>
                            <td style="background: #e3eef8; padding: 5px" class="text-right"><strong> {{number_format((float)$total, 2, '.', '')}}</strong></td>
                        </tr>
                        @foreach ($radnici_po_proizvodu as $br_radnika)
                        <tr class="well">
                            <th colspan="2"></th>
                            <th colspan="3" style="background: #e3eef8; padding: 5px;" class="text-right"><div> Ukupno - troškovi rada</div></th>
                            <td style="background: #e3eef8; padding: 5px" class="text-right"><strong> {{number_format((float)(($br_radnika->ukupno_usvojeno*8*$norma_sat->vrijednost)/(100*$proizvod->proizvoda_u_smjeni)), 2, '.', '')}}</strong></td>
                        </tr> 
                        <tr class="well" >
                            <th colspan="2"></th> 
                            <th colspan="3" style="background: #e3eef8; padding: 5px;" class="text-right"><div> Ukupna cijena koštanja</div></th>
                            <td style="background: #e3eef8; padding: 5px" class="text-right"><strong> {{number_format((float)$total+($br_radnika->ukupno_usvojeno*8*$norma_sat->vrijednost/(100*$proizvod->proizvoda_u_smjeni)), 2, '.', '')}}</strong></td>
                        </tr>
                        @endforeach      
                </tbody>
            </table>
