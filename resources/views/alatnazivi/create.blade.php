@extends('layouts.app', ['activePage' => 'grupe_alata', 'menuParent' => 'sifrarnici', 'titlePage' => __('Vrsta/namjena alata - dodavanje')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('alatnaziv.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Vrsta/namjena - dodavanje') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group{{ $errors->has('vrsta_namjena') ? ' has-danger' : '' }}">
                        ...
                        <option value="{{ $vrsta_namjena}}" >{{ $vrsta_namjena }}</option>
                        @endforeach
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10 checkbox-radios">
                    <div class="togglebutton">
                      <label>
                        <input type="checkbox" name="aktivan" value="1" {{ old('aktivan') == 1 ? ' checked' : '' }}>
