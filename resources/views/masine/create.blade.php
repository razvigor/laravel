...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('masina.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            <div class="card ">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">{{ __('Dodavanje nove mašine') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('r_br') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('r_br') ? ' is-invalid' : '' }}" name="r_br" id="input-r_br" type="text" placeholder="{{ __('') }}" value="{{ old('r_br') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('masinvrsta_id') ? ' has-danger' : '' }}">
                        ...
                        <option value="{{ $vrsta->id }}" {{ $vrsta->id == old('masinvrsta_id') ? 'selected' : '' }}>{{ $vrsta->name }}</option>
                        @endforeach
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('masinlokacija_id') ? ' has-danger' : '' }}">
                        <select class="selectpicker col-sm-12 pl-0 pr-0" name="masinlokacija_id" data-style="select-with-transition" title="" data-size="100">
                        <option value="">-</option>
                        @foreach ($masinlokacija as $lokacija)
                        <option value="{{ $lokacija->id }}" {{ $lokacija->id == old('masinlokacija_id') ? 'selected' : '' }}>{{ $lokacija->naziv }}</option>
                        @endforeach
                      </select>
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label label-checkbox">{{ __('Bruto mjere (isklj. neto  mjere)') }}</label>
                  <div class="col-sm-10 checkbox-radios">
                    <div class="togglebutton">
                      <label>
                        <input type="checkbox" name="bruto_mjere" value="1" {{ old('bruto_mjere') == 1 ? ' checked' : '' }}>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="form-group{{ $errors->has('inst_ee_kw') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('inst_ee_kw') ? ' is-invalid' : '' }}" name="inst_ee_kw" id="input-inst_ee_kw" type="text" placeholder="{{ __('') }}" value="{{ old('inst_ee_kw') }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="form-group{{ $errors->has('opt_fi1') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('opt_fi1') ? ' is-invalid' : '' }}" name="opt_fi1" id="input-opt_fi1" type="text" placeholder="{{ __('') }}" value="{{ old('opt_fi1') }}" />
                      @include('alerts.feedback', ['field' => 'opt_fi1'])
                    </div>
                    <div class="form-group{{ $errors->has('opt_fi2') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('opt_fi2') ? ' is-invalid' : '' }}" name="opt_fi2" id="input-opt_fi2" type="text" placeholder="{{ __('') }}" value="{{ old('opt_fi2') }}" />
                      @include('alerts.feedback', ['field' => 'opt_fi2'])
                    </div>
                    <div class="form-group{{ $errors->has('opt_fi3') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('opt_fi3') ? ' is-invalid' : '' }}" name="opt_fi3" id="input-opt_fi3" type="text" placeholder="{{ __('') }}" value="{{ old('opt_fi3') }}" />
                  ...
                  <div class="col-sm-1">
                    <div class="form-group{{ $errors->has('opt_kom1') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('opt_kom1') ? ' is-invalid' : '' }}" name="opt_kom1" id="input-opt_kom1" type="text" placeholder="{{ __('') }}" value="{{ old('opt_kom1') }}" />
                      @include('alerts.feedback', ['field' => 'opt_kom1'])
                    </div>
                    <div class="form-group{{ $errors->has('opt_kom1') ? ' has-danger' : '' }}">                      
                      <input class="form-control{{ $errors->has('opt_kom2') ? ' is-invalid' : '' }}" name="opt_kom2" id="input-opt_kom2" type="text" placeholder="{{ __('') }}" value="{{ old('opt_kom2') }}" />
                      @include('alerts.feedback', ['field' => 'opt_kom2'])
                    </div>
                    <div class="form-group{{ $errors->has('opt_kom1') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('opt_kom1') ? ' is-invalid' : '' }}" name="opt_kom3" id="input-opt_kom3" type="text" placeholder="{{ __('') }}" value="{{ old('opt_kom3') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-10 checkbox-radios">
                    <div class="togglebutton">
                      <label>
                        <input type="checkbox" name="kz" value="1" {{ old('kz') == 1 ? ' checked' : '' }}>
                        <span class="toggle"></span>
                      </label>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="form-group{{ $errors->has('kz_p') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('kz_p') ? ' is-invalid' : '' }}" name="kz_p" id="input-kz_p" type="text" placeholder="{{ __('') }}" value="{{ old('kz_p') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-1">
                    <div class="form-group{{ $errors->has('kz_l') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('kz_l') ? ' is-invalid' : '' }}" name="kz_l" id="input-kz_l" type="text" placeholder="{{ __('') }}" value="{{ old('kz_l') }}" />
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Datum') }}</label>
                  <div class="col-sm-7">
