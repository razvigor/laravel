    ...
    <head>
        ...
        <style>
            ...
            .text-right {
                text-align: right;
                font-size: 12px;
                border-bottom: 1px solid #bddaf5;
            }
        ...
        <div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <h4  style="text-align: center; font-size: 16px;">Pregled zaliha</h4>
{{--
                    <address>
            ...
            <table style="width: 100%;">
                <thead style="background: #c9dbec;">
                    <tr>
                        ...
                        <th class="text-left" rowspan="2" style="padding: 5px;" >Tip</th>
                        <th class="text-left" rowspan="2" style="padding: 5px;" >Oznaka</th>
                        <th class="text-center" colspan="2">Servis</th>
                ...
                <tbody>
                        ...
                        @foreach ($result as $stavke)
                            ...
                            <tr width="100%">
                                ...
                                <td class="text-left-tip"  style="padding: 0px 5px 0px 5px ;">{{$stavke->tip}}</td>
                                <td class="text-left"  style="padding: 0px 5px 0px 5px ;">{{$stavke->oznaka}}</td>
                                <td class="text-center" width="10% "style="padding: 5px 0px 5px 0px;">{{$stavke->na_stanju_s}}</td>
                                <td class="text-center" width="10%">{{$stavke->limit_s}}</td>
                                <td class="text-center" width="10%">{{$stavke->na_stanju_r}}</td>
                                <td class="text-center" width="10%">{{$stavke->limit_r}}</td>
