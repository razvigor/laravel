...
<html>
    ...
    <body class="login-page" style="background: white">
        ...
        <div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <h4  style="text-align: center; font-size: 16px;">IZDATNICA MATERIJALA</h4>
                    <address>
            ...
            <table style="width: 100%;">
                <thead style="background: #c9dbec;">
                    <tr>
                        ...
                        <th class="text-left" rowspan="2">Materijal</th>
                        <th class="text-center" rowspan="2">Jedinica<br> mjere</th>
                        <th class="text-center" rowspan="2">Količina</th>
                        <th class="text-center" colspan="2">Datum: ___ / ___ / ___</th>
                        <th class="text-center" colspan="2">Datum: ___ / ___ / ___</th>
                        <th class="text-center" colspan="2">Datum: ___ / ___ / ___</th>
                        <th class="text-center" rowspan="2">Ukupno<br> izdato</th>

                    </tr>

                    <tr>
                        <th class="text-center" >Izdato</th><th>Potpis</th>
                        <th class="text-center" >Izdato</th><th>Potpis</th>
                        <th class="text-center" >Izdato</th><th>Potpis</th>
                ...
                <tbody>
                    ...
                    <tr class="well" style="background: #e1edf8; padding: 5px">
                            <th colspan="4" style="padding: 5px;" class="text-left"><div> {{$tip->mattip_naziv}}</div></th>
