        ...
        <div>
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <h4  style="text-align: center; font-size: 16px;">RADNI NALOG</h4>
                    <address>
            ...
            <table style="width: 100%;">
                <thead style="background: #c9dbec;">
                    <tr>
                        ...
                        <th class="text-left" style="padding: 5px;" >Proizvod</th>
                        <th class="text-center" >Kapacitet<br>(kom)</th>
                        <th class="text-center" >Količina</th>
                        <th class="text-left" style="padding: 5px;" >Napomena</th>
                ...
                <tbody>
                        ...
                        @foreach ($result as $stavke)
                            ...
                            <tr width="100%">
                                ...
                                <td class="text-center">{{$stavke->r_br}}</td>
                                <td class="text-left" style="padding: 5px;"><div>{{$stavke->naziv_kupca}}</div></td>
                                <td class="text-left" style="padding: 5px;">{{$stavke->naziv_proizvoda}}</td>
                                <td class="text-center">{{$stavke->proizvoda_u_smjeni*$nalog->broj_dana}}</td>
                                <td class="text-center">{{$stavke->kolicina}}</td>
                                <td class="text-left" style="padding: 5px;">{{$stavke->napomena}}</td>
