...
class Turbina_WS_RES extends JsonResource
{
    /**
...
// #########################################################################################################################
        ...
        return [
            ...
            'CW_slike' => JsonResource::collection($CW_slike),
            'TW_slike' => JsonResource::collection($TW_slike),
            'BH_slike' => JsonResource::collection($BH_slike),
            'BP_slike' => JsonResource::collection($BP_slike),
            'HS_slike' => JsonResource::collection($HS_slike),
            'AC_slike' => JsonResource::collection($AC_slike),
            'NZ_slike' => JsonResource::collection($NZ_slike),
            'GK_slike' => JsonResource::collection($GK_slike),
            'RK_slike' => JsonResource::collection($RK_slike),
            'TH_slike' => JsonResource::collection($TH_slike),
            'CN_slike' => JsonResource::collection($CN_slike),
            ...
            // X cijene ////////////////////////////////////////////////////////////////////////
                                ...
                                'X12_na_cijena_2'=>$this->X12_2===0?'-':Turbinadio::where('id','=',$this->X12_2)->value('cijena')/100,
                                'X12_na_cijena_2_as'=>$this->X12_2===0?'-':Turbinadio::where('id','=',$this->X12_2)->value('cijena_as')/100,
                                'X12_na_cijena_2_ts'=>$this->X12_2===0?'-':Turbinadio::where('id','=',$this->X12_2)->value('cijena_ts')/100,
