...
class Turbine_WS_RES extends JsonResource
{
    /**
...
// #########################################################################################################################
        ...
        return [
            ...
            //27/mar/2023//'CW_napomena'            =>$this->CW_napomena,       
            'comp_wheel_oznaka'      =>$this->comp_wheel===0?'-':Turbinadio::where('id','=',$this->comp_wheel)->value('oznaka'),
            //27/mar/2023//'comp_wheel_na_stanju'   =>$this->comp_wheel===0? 0 :Turbinadio::where('id','=',$this->comp_wheel)->sum(\DB::raw('na_stanju_s + na_stanju_r')),
            //27/mar/2023//'comp_wheel_u_servisu'   =>Turbinadio::where('id','=',$this->comp_wheel)->sum(\DB::raw('na_stanju_s')),
            //27/mar/2023//'comp_wheel_cijena'      =>$this->comp_wheel===0?'-':Turbinadio::where('id','=',$this->comp_wheel)->value('cijena')/100,
            // niz ekvivalentnih dijelova (može biti prazan)
            //27/mar/2023//'comp_wheel_ekvivalenti' => JsonResource::collection($comp_wheel_ekvivalenti),

            'comp_wheel_2'             =>$this->comp_wheel_2,
            //27/mar/2023//'CW_napomena_2'            =>$this->CW_napomena_2,       
            'comp_wheel_oznaka_2'      =>$this->comp_wheel_2===0?'-':Turbinadio::where('id','=',$this->comp_wheel_2)->value('oznaka'),
            //27/mar/2023//'comp_wheel_na_stanju_2'   =>$this->comp_wheel_2===0? 0 :Turbinadio::where('id','=',$this->comp_wheel_2)->sum(\DB::raw('na_stanju_s + na_stanju_r')),
            //27/mar/2023//'comp_wheel_u_servisu_2'   =>Turbinadio::where('id','=',$this->comp_wheel_2)->sum(\DB::raw('na_stanju_s')),
            //27/mar/2023//'comp_wheel_cijena_2'      =>$this->comp_wheel_2===0?'-':Turbinadio::where('id','=',$this->comp_wheel_2)->value('cijena')/100,
            // niz ekvivalentnih dijelova (može biti prazan)
            //27/mar/2023//'comp_wheel_ekvivalenti_2' => JsonResource::collection($comp_wheel_ekvivalenti_2),            

            'comp_wheel_3'             =>$this->comp_wheel_3,
            //27/mar/2023//'CW_napomena_3'            =>$this->CW_napomena_3,       
            'comp_wheel_oznaka_3'      =>$this->comp_wheel_3===0?'-':Turbinadio::where('id','=',$this->comp_wheel_3)->value('oznaka'),
            //27/mar/2023//'comp_wheel_na_stanju_3'   =>$this->comp_wheel_3===0? 0 :Turbinadio::where('id','=',$this->comp_wheel_3)->sum(\DB::raw('na_stanju_s + na_stanju_r')),
            //27/mar/2023//'comp_wheel_u_servisu_3'   =>Turbinadio::where('id','=',$this->comp_wheel_3)->sum(\DB::raw('na_stanju_s')),
            //27/mar/2023//'comp_wheel_cijena_3'      =>$this->comp_wheel_3===0?'-':Turbinadio::where('id','=',$this->comp_wheel_3)->value('cijena')/100,
            // niz ekvivalentnih dijelova (može biti prazan)
            //27/mar/2023//'comp_wheel_ekvivalenti_3' => JsonResource::collection($comp_wheel_ekvivalenti_3),            
